...
var child_process_1 = require("child_process"); //spawn
...
var rtmpToHLS = function (streamPath) {
    ...
    // - TODO: fs.mkdir
    try {
        mkdirp_1.default.sync(MEDIA_ROOT);
        fs_1.default.accessSync(MEDIA_ROOT, fs_1.default.constants.W_OK);
    }
    catch (error) {
    ...
    try {
        mkdirp_1.default.sync("" + MEDIA_ROOT + streamPath);
        fs_1.default.accessSync("" + MEDIA_ROOT + streamPath, fs_1.default.constants.W_OK);
    }
    catch (error) {
    ...
    child_process_1.exec(ffmpeg_static_1.default + " " + misc_params + " -i " + source + " " + cmd, function (e, stdout, stderr) {
        if (e) {
    ...
    fs_1.default.writeFile("" + MEDIA_ROOT + streamPath + "/playlist.m3u8", master_playlist, function () { });
